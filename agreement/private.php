...
<div id="wrap" class="<? echo $fileName[1] ?>">
  ...
  <div id="contents">
    <div id="titleArea" style="background-image:url(../images/title_bg/<? echo $fileName[1] ?>.png);">
      ...
      <h2><?=$siteName?><img src="../images/global/icon_triangle.png" alt="▶" />이용약관<img src="../images/global/icon_triangle.png" alt="▶" /><strong>개인정보 처리방침</strong></h2>
      <h1>개인정보 처리방침</h1>
    </div>
    <div class="textArea">
    </div>
