...
//보안을 위해 제공해드리는 샘플페이지는 서비스 적용 후 서버에서 삭제해 주시기 바랍니다. 
	...
	*****************************/
	...
	$sSiteCode					= "BW80";			// IPIN 서비스 사이트 코드		(NICE평가정보에서 발급한 사이트코드)
	$sSitePw					= "Lsocom1!";			// IPIN 서비스 사이트 패스워드	(NICE평가정보에서 발급한 사이트패스워드)
...
var result = '<?= $sRtnMsg ?>'
var userName = '<?= iconv("EUC-KR","UTF-8",$strUserName) ?>';
var userBirth = '<?= $strBirthDate ?>';
var sex = '<?= $strGender ?>';
...
if(result == 'Y'){
	...
	처리결과 : <?= $sRtnMsg ?><br>
	이름 : <?= iconv("EUC-KR","UTF-8",$strUserName) ?><br><?= $strBirthDate ?><?= $strGender ?>
