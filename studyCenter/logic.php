...
<div id="wrap">
  <div id="contents">
    <div id="titleArea" style="background-image:url(../images/title_bg/<? echo $fileName[1] ?>.png);">
      ...
      <h2>교육안내<img src="../images/global/icon_triangle.png" alt="▶" /><strong>교육진행절차</strong></h2>
      <h1>교육진행절차</h1>
    </div>
    ...
    <div class="logic">
      ...
      <ol>
        <li>수강할 업체 사업자등록증을  이메일(<span>cslim003@dutycenter.co.kr</span>)  로 보내주세요.</li>
        <li>학습을 진행할 사이트에서 수강신청을 합니다.</li>
        <li>최종 확정자 명단을 기준으로 위탁계약서를 2부 작성하여<br />1부는 교육기관 이메일로 보내주세요.</li>
        <li>학습자는 수강기간에 맞춰 수강을 진행하며, 교육기관은 문자,<br />이메일 등을 통해 학습을 독려합니다.</li>
        <li>수강이 종료되면 첨삭강사가 평가에 대한 첨삭을 진행합니다.</li>
        <li>첨삭이 완료되면 학습자들에게 평가결과를 안내합니다.</li>
        <li>학습자의 평가결과 확인 후 교육기관은 관할 산업인력공단에 수료보고를 합니다.</li>
      </ol>
    </div>
    <!-- 동작호출부 -->
    <!-- //동작호출부 -->
