...
<div id="wrap">
  <div id="contents">
    <div id="titleArea" style="background-image:url(../images/title_bg/<? echo $fileName[1] ?>.png);">
      ...
      <h2>교육안내<img src="../images/global/icon_triangle.png" alt="▶" /><strong>위탁교육안내</strong></h2>
      <h1>위탁교육안내</h1>
    </div>
    ...
    <div class="eduinfoArea">
      ...
      <h2>사업주가 훈련비용을 부담하여 재직근로자, 채용예정자를 다른 훈련기관에 위탁하고 해당 훈련기관이 훈련실시,<br />훈련생관리 등을 직접 수행하는 직업능력개발훈련입니다.</h2>
      <ol>
        <li>
        ...
        <li>
          ...
          <h2>사업주는 훈련비 중 정부지원금을 제외한 자기부담금을 훈련기관에 납부하여 재직근로자 등을 대상으로<br /> 직업훈련을 실시하는 경우 고용노동부에서 훈련비 등을 지원합니다.</h2>
        ...
        <li>
          ...
          <table>
            ...
            <tr>
              <td rowspan="3">훈련비</td>
              <td>우선지원기업</td>
              <td class="tableLeft">훈련에 소요된 비용의 일부 지원<br />표준훈련비 : 등급별 훈련비×훈련시간×수료인원×120%</td>
            </tr>
            <tr>
              <td style="border-left:1px solid #b8c4c6;">중견기업<br />(1000인 미만)</td>
              <td class="tableLeft">훈련에 소요된 비용의 일부 지원<br />표준훈련비 : 등급별 훈련비×훈련시간×수료인원×80%</td>
            </tr>
            <tr>
              <td style="border-left:1px solid #b8c4c6;">대기업<br />(1000인 이상)</td>
              <td class="tableLeft">
                훈련에 소요된 비용의 일부 지원<br />표준훈련비 : 등급별 훈련비×훈련시간×수료인원×50%
      ...
      <img src="../images/eduinfo/img_info05.png" alt="지원한도" class="imgInfo02" />
      <!--<img src="../images/eduinfo/img_info02.png" alt="우선지원대상 기업 = 등급별 훈련비 * 훈련시간 * 수료인원 * 100%" class="imgInfo02"/><br />
      <img src="../images/eduinfo/img_info03.png" alt="중견 기업 = 등급별 훈련비 * 훈련시간 * 수료인원 * 60%" class="imgInfo03"/>
	  <img src="../images/eduinfo/img_info04.png" alt="대규모 기업 = 등급별 훈련비 * 훈련시간 * 수료인원 * 50%" class="imgInfo04"/>-->
    </div>
    <!-- 동작호출부 -->
    <!-- //동작호출부 -->
  </div>
