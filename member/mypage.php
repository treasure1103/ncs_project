...
//보안을 위해 제공해드리는 샘플페이지는 서비스 적용 후 서버에서 삭제해 주시기 바랍니다. 
	...
	$sReturnURL					= "http://ncscenter.kr/member/ipin_process.php";			// 하단내용 참조
	$sCPRequest					= "";			// 하단내용 참조
  ...
  <div id="contents">
    <div id="titleArea" style="background-image:url(../images/title_bg/<? echo $fileName[1] ?>.png);">
	  ...
	  <? if($_SESSION['loginUserID'] == "" ){
					if($_SESSION['loginUserID'] == "" ){
						echo "<script>";
						echo "alert('회원가입은 고객센터로 문의 바랍니다.');";
						echo "top.location.href='/main/'";
						echo "</script>";
						exit;
					}
		?>
        ...
        <h1>회원가입</h1>
      <? }else{ ?>
        <h2><?=$siteName?><img src="../images/global/icon_triangle.png" alt="▶" />마이페이지<img src="../images/global/icon_triangle.png" alt="▶" /><strong>개인정보변경</strong></h2>
        <h1>개인정보변경</h1>
      <? } ?>
    </div>
    <div id="contentsArea">
