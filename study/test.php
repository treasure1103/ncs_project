...
//휴대폰 본인인증
    ...
    $returnurl = "http://esangedu.kr/member/checkplus_success.php";	// 성공시 이동될 URL
    $errorurl = "http://esangedu.kr/member/checkplus_fail.php";		// 실패시 이동될 URL
...
//아이핀 인증	
	...
	$sReturnURL					= "http://esangedu.kr/member/ipin_process.php";			// 하단내용 참조
	$sCPRequest					= "";			// 하단내용 참조
...
<iframe src='http://cont2.esangedu.kr/session/session.php?SESSID="<?=$_COOKIE["PHPSESSID"];?>"' width=0 height=0></iframe>
