...
<div id="wrap" class="<? echo $fileName[1] ?>">
  ...
  <div id="contents">
    <div id="titleArea" style="background-image:url(../images/title_bg/<? echo $fileName[1] ?>.png);">
      ...
      <h2><?=$siteName?><img src="../images/global/icon_triangle.png" alt="▶" />교육안내<img src="../images/global/icon_triangle.png" alt="▶" /><strong>교육이용 안내</strong></h2>
      <h1>교육이용 안내</h1>
    </div>
    <div class="rule">
      <!-- 
      <img src="../images/eduinfo/img_rule01.png" alt="이용안내1" />
      <img src="../images/eduinfo/img_rule02.png" alt="이용안내2" />
      <img src="../images/eduinfo/img_rule03.png" alt="이용안내3" />
      <img src="../images/eduinfo/img_rule04.png" alt="이용안내4" />
      <img src="../images/eduinfo/img_rule05.png" alt="이용안내5" />
       -->
      <ol>
        <li>
        ...
        <li>
          ...
          <ul>
            <li>
              <?=$_siteName?>의 교육서비스는 본인 인증을 위해 다음과 같은 페이지에서  <strong class="blue">휴대폰인증 혹은 아이핀 인증</strong>을 필요로 합니다.
              <ul>
        ...
        <li>
          <span class="titleBlue">수료기준</span> 안내
          <ul>
            <li>모든과정의 수료기준은 <strong class="blue">진도율 80% 이상</strong>, <strong class="red">총점 60점 이상</strong>입니다.</li>
						<li>평가 항목이나 반영비율은 <strong class="blue">과정별 상이할 수</strong>있습니다.</li>
          </ul>
        </li>
        <li>
          강의 진행 시 <span class="titleBlue">주의사항</span>
          <ul>
            <li><strong class="blue">중간평가</strong>는 강의 전체차시 기준 <strong class="red">50% 이상 되어야 응시 가능</strong>합니다. </li>
