...
ini_set("display_errors", 1);
    ...
    $CST_MID                    = "nayanet";                             //상점아이디(LG유플러스으로 부터 발급받으신 상점아이디를 입력하세요)
    ...
    //$LGD_OID                    = $_POST["LGD_OID"];                             //주문번호(상점정의 유니크한 주문번호를 입력하세요)
		//$LGD_MERTKEY								= "aa7d95db6f74e6e55389156b2dcb7716";
     ...
     */    
    $LGD_CASNOTEURL				= "http://esangedu.kr/lib/payment/cas_noteurl.php";    

    /*
     * LGD_RETURNURL 을 설정하여 주시기 바랍니다. 반드시 현재 페이지와 동일한 프로트콜 및  호스트이어야 합니다. 아래 부분을 반드시 수정하십시요.
     */    
    $LGD_RETURNURL				= "http://esangedu.kr/lib/payment/returnurl.php";  


    $configPath                 = "/home/nynLMS/lib/payment/lgdacom";                                  //LG유플러스에서 제공한 환경파일("/conf/lgdacom.conf") 위치 지정.     
